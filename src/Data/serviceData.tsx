export const services = [
  { 
    ...
    content: `Many homeowners are finding that it’s more practical to renovate their existing property in order to create their dream home, rather than selling up and looking for it. Lambert & Wright specialise in property renovations in the East Midlands and have a host of experience making many homeowners' dreams a reality. It often comes as a surprise to homeowners when they find out what it costs to renovate a property, as it may be a lot less than you think. If you are looking for a leader in providing home renovations to the East Midlands, then you have come to the right place. With over 30 years’ experience, a team of trusted and experienced East Midlands tradesmen, and a long list of thrilled customers, there really is no better company to work with on your property renovations in the East Midlands than with Lambert & Wright. Trust in the knowledge that: Project Management: We have experienced project managers that will be with you through to completion. Trusted Suppliers: We use exclusive and trusted suppliers/merchants for all aspects of your renovation and always recommend our customers to these suppliers. Tradesmen: All tradesmen that we use are vetted, are highly experienced and recommended. Financial services: We can introduce you to our external financial advisors who can help you with any mortgage advice and assist with applications.`,
    image: '/images/ServicesData/projectPlanning.jpg',
  },
  { 
    id: 2, 
  ...
  { 
    ...
    content: `Our plumbing and electrical services include electrical design and installation, kitchen and bathroom installations, hot and cold pipework alterations, above ground drainage systems, hot water system upgrades, heating system upgrades, and boiler installations. We specialise  Electrical Design & Installation - Kitchen & Bathroom Installations - Hot/Cold Pipework Alterations/Upgrades - Above Ground Drainage Systems - Hot Water System Upgrades - Heating System Upgrades - Boiler Installations Our team of certified plumbers and electricians are experienced in handling all types of plumbing and electrical work, ensuring your home systems are safe, efficient, and up-to-date.`,
...
Our design services cover interior decorating, kitchen and bathroom designs, tiling, wooden floors, carpet fitting, door and window upgrades and exterior landscaping,.
...
Our creative design team works closely with you to transform your home interiors into a stylish and comfortable living space that reflects your personal taste and lifestyle.
 `,
 image: '/images/ServicesData/Design.png',
  },
  { 
    id: 5, 
    ...
    content: `Are you in need of more space in your home but don’t want to move? Getting an extension could be the solution you are looking for. In today’s market, it can actually be cheaper to extend than it is to move. Whether it’s a new kitchen that you are after, an extra bedroom, or an additional living area, an extension is a great way to provide that added space to your property to support your changing needs or your growing family. There are various rules and regulations to be aware of when considering an extension as these can determine what is needed in order to start your project. Lambert & Wright have a team of experts who will assist you during this stage in the process to ensure that you get exactly what you want whilst adhering to all rules and regulations.`,
    image: '/images/ServicesData/PropertyExtensions.jpg',
  },
  { 
    id: 6, 
    title: 'LANDSCAPING', 
    ...
    images:[ 
      '/images/ServicesData/Landscaping1.png',
      '/images/ServicesData/Landscaping2.jpg',
    ]
  },
  { 
    id: 7, 
    ...
    content: `The kitchen is often called the ‘heart’ of the home, which is why we give so much care and attention towards your projects. With over 30 years of experience in home renovations, refurbishments, and kitchen and bathroom fittings, we are the perfect choice in Leicestershire for your kitchen and bathroom renovation needs. No matter the size of your kitchen or bathroom, you should be able to relax and enjoy them. If this isn’t how you feel in these areas, then allow us to take the stress away by creating a bespoke kitchen or bathroom design for you that gives you everything that you need. You might have some ideas of what you want but aren’t sure how to piece it all together or what direction to go in – that is where L&W Bespoke Property Renovations come in. With our extensive knowledge and experience in the industry, we are the first choice for many homeowners across Leicestershire when it comes to kitchen and bathroom design and renovations.`,
    images: [
      '/images/Bathrooms/Bath%201.jpg',
      '/images/Bathrooms/Bath%202.jpg',
      '/images/Bathrooms/Bath%206.jpg',
      '/images/Bathrooms/Bath3.jpg',
      '/images/Bathrooms/Bath4.JPG',
      '/images/Bathrooms/Bath5.JPG',
      '/images/Bathrooms/Bumblebee%20Cottage,%20Main%20Street,%20Burton%20Overy-26.jpg',
      '/images/Bathrooms/Bumblebee%20Cottage,%20Main%20Street,%20Burton%20Overy-36.jpg',
      '/images/Bathrooms/Bumblebee%20Cottage,%20Main%20Street,%20Burton%20Overy-37.jpg',
      '/images/Bathrooms/Bumblebee%20Cottage,%20Main%20Street,%20Burton%20Overy-38.jpg',
      '/images/Bathrooms/Bumblebee%20Cottage,%20Main%20Street,%20Burton%20Overy-39.jpg',
      '/images/Bathrooms/Bumblebee%20Cottage,%20Main%20Street,%20Burton%20Overy-40.jpg',
    ]
  },
  { 
    id: 8, 
    ...
    content: `Efficient heating systems in your home not only provide the comfort that you desire but, when selected correctly, can create a more energy-efficient home. Whether you are looking for underfloor heating, a new boiler system, or just making improvements to your existing system, you can work with L&W to get the best result for your home. Our heating services include: - Underfloor Heating Installation - Boiler System Installation & Upgrades - Radiator Installation & Upgrades - Thermostat Installation - Heating System Maintenance & Repair Let us help you create a warm and comfortable home with our expert heating installation and upgrade services.`,
